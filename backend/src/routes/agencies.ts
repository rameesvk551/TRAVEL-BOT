...
const updateAgencySchema = z.object({
  ...
  whatsappMissedCallAutoReplyEnabled: z.boolean().optional(),
  whatsappMissedCallAutoReplyMessage: z.string().trim().max(900).nullable().optional(),
  whatsappMissedCallUnknownAction: z.enum(['LOG_ONLY', 'CREATE_LEAD']).optional(),
