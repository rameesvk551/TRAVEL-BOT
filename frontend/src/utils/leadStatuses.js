export const LEAD_STATUS_OPTIONS = ['JUST_CONTACTED', 'PACKAGE_SEARCHED', 'PACKAGE_INTERESTED', 'CONTACTED', 'CONVERTED', 'LOST'];

export const LEAD_PIPELINE_COLUMNS = [
  { key: 'JUST_CONTACTED', label: 'Just Contacted', color: 'sky' },
