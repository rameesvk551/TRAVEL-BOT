  ...
  return (
    <div className="p-6 md:p-8 space-y-6 animate-in fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <div className="rounded-[14px] border border-slate-200 bg-white p-4 flex gap-4 items-center hover:shadow-md transition-shadow">
        ...
        <div className="rounded-[14px] border border-slate-200 bg-white p-4 flex gap-4 items-center hover:shadow-md transition-shadow border-l-4 border-l-teal-500">
        ...
        <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center gap-3 bg-slate-50/50">
          ...
          <div className="relative flex-1 max-w-sm ml-auto">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 pl-9 pr-4 py-2 text-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 outline-none transition"
              value={searchQuery}
                    ...
                    >
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-500 group-hover:bg-teal-50 group-hover:text-teal-600 transition">
                        ...
                        {c.status === 'DRAFT' || c.totalRecipients === 0 ? (
                          ...
                          <div className="flex items-center gap-2">
                            <div className="flex-1 bg-slate-100 h-2 rounded-full overflow-hidden flex">
                              <div className="bg-teal-500 h-full rounded-l-full" style={{ width: `${Math.max(2, (c.read / Math.max(1, c.totalRecipients)) * 100)}%` }} />
                              <div className="bg-emerald-300 h-full" style={{ width: `${Math.max(0, ((c.delivered - c.read) / Math.max(1, c.totalRecipients)) * 100)}%` }} />
                            </div>
