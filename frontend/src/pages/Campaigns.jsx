...
const STATUS_BADGE = {
  SENT: 'bg-[#f5f5f5] text-[#2d2d2d] border-[#d4d4d4]',
    ...
    <div className="p-6 md:p-8 space-y-6 animate-in fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl bg-[#2d2d2d] px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#1a1a1a] transition self-start"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="rounded-[14px] border border-slate-200 bg-white p-4 flex gap-4 items-center hover:shadow-md transition-shadow border-l-4 border-l-[#f0f0f0]0">
          <div className="w-12 h-12 rounded-full bg-[#f0f0f0] flex items-center justify-center text-[#404040]">
        ...
        <div className="rounded-[14px] border border-slate-200 bg-white p-4 flex gap-4 items-center hover:shadow-md transition-shadow">
          <div className="w-12 h-12 rounded-full bg-[#f5f5f5] flex items-center justify-center text-[#404040]">
